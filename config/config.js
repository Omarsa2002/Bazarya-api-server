...
CONFIG.PAYMOB_BASE_URL = process.env.PAYMOB_BASE_URL
CONFIG.PAYMOB_API_KEY = process.env.PAYMOB_API_KEY,
CONFIG.PAYMOB_CARD_INTEGRATION_ID = process.env.PAYMOB_CARD_INTEGRATION_ID,
CONFIG.PAYMOB_WALLET_INTEGRATION_ID = process.env.PAYMOB_WALLET_INTEGRATION_ID,
CONFIG.PAYMOB_VODAFONE_INTEGRATION_ID = process.env.PAYMOB_VODAFONE_INTEGRATION_ID,
CONFIG.PAYMOB_ORANGE_INTEGRATION_ID = process.env.PAYMOB_ORANGE_INTEGRATION_ID,
CONFIG.PAYMOB_ETISALAT_INTEGRATION_ID = process.env.PAYMOB_ETISALAT_INTEGRATION_ID,
CONFIG.PAYMOB_INSTALLMENT_INTEGRATION_ID = process.env.PAYMOB_INSTALLMENT_INTEGRATION_ID,
CONFIG.PAYMOB_HMAC_SECRET = process.env.PAYMOB_HMAC_SECRET,
CONFIG.PAYMOB_IFRAME_ID = process.env.PAYMOB_IFRAME_ID,
CONFIG.PAYMOB_WALLET_IFRAME_ID = process.env.PAYMOB_WALLET_IFRAME_ID,
CONFIG.PAYMOB_INSTALLMENT_IFRAME_ID = process.env.PAYMOB_INSTALLMENT_IFRAME_ID,
